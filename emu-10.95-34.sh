...
function launchQuickEmulator() {
  cd /c/Users/pablo/AppData/Local/Android/Sdk/emulator/ && ./emulator -avd Pixel_Tablet_10.95_API_34_Android_14 -no-snapshot-load -no-snapshot-save # -n-s-l = COLD BOOT
}
